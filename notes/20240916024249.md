...
.satu {
  ...
  width: 200px;
  height: 200px;
  margin: 50px; /* seluruh margin */
}
.dua {
  background-color: blue;
  width: 100px;
  height: 100px;
  margin: 100px 50px; /* top|bottom left|right */
}
.tiga {
  background-color: yellow;
  width: 50px;
  height: 50px;
  margin: 20px 50px 40px; /* top left|right bottom */
}
.empat {
  background-color: orange;
  width: 25px;
  height: 25px;
  margin: 20px 50px 30px 40px; /* top right bottom left */
}
```
